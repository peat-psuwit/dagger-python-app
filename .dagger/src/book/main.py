...
class Book:
    ...
    def env(self, source: dagger.Directory) -> dagger.Container:
        return (
            dag.container()
            .from_("docker.io/library/python:3.11")
            # TODO: avoid persisting cache
            .with_exec(["sh", "-c", 
    ...
    @function
    async def publish(self, source: dagger.Directory, image_name: str) -> str:
